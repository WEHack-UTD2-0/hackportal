      ...
      {currentUser === '' ? (
        <>
          <div className="top-6 p-4 flex flex-row items-center gap-x-2">
            <h1 className="font-bold text-lg" style={{ color: '#FFE9D7' }}>
              Search Users
            </h1>
            <input
              type="text"
          ...
          <div className="p-4 flex flex-row w-full" style={{ color: '#FFE9D7' }}>
            <div className="w-full md:w-1/6 lg:w-1/12 flex flex-col gap-y-4">
              ...
              <div className="my-4">
                <h1 className="text-md font-bold text-center mb-4" style={{ color: '#FFE9D7' }}>
                  Sort By:
                </h1>
                <h4

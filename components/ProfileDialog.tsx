...
export default function ProfileDialog({ onDismiss }: ProfileDialogProps) {
  ...
  return (
    <div className="profileDialog absolute top-8 right-8 min-w-xl max-w-2xl shadow-md rounded-md bg-green-100">
      ...
      {(isSignedIn && (
        <>
          <div onClick={onDismiss}>
            <Link href="/profile">
              <a className="block p-4 hover:bg-green-200">
                <NotesIcon />
          ...
          <div className="rounded-b-md" onClick={onDismiss}>
            <Link href="/auth/signOut">
              <a className="block p-4 hover:bg-green-200 rounded-b-md">
                <ExitToAppIcon />
